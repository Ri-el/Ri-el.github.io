...
| Gnawed and Preserved Abyssal Bones | `boneDisabledReason` | `startDesecrationFlow` / `CraftingEngine.startDesecration` | Reuses the existing Well flow with each retained direction, replacement count, reroll count, and item-class restriction; these shared transitions are labelled inferred. |
