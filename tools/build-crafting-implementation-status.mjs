...
export function buildReport(index, indexSource) {
  ...
  return {
    ...
    auditFindings: {
      ...
      poe2dbDisposition: 'The supplied autocomplete and ModsView assets aided route/schema discovery only; the empty HAR did not verify a mechanics JSON endpoint, so no runtime or build dependency was added.',
